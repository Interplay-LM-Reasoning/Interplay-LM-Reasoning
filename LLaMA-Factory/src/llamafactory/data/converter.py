...
def compose_text(obj: dict) -> str:
    ...
    assert problem and question and solution
...
class PRLDatasetConverter(DatasetConverter):
    """
    "columns": {
      "problem": "problem",
      "question": "question",
    ...
    Note: the code might not be so robust
    """
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:

        output = {
            "_prompt": compose_text(example),
            }
        return output

DATASET_CONVERTERS = {
    "alpaca": AlpacaDatasetConverter,
    "physics_rl": PRLDatasetConverter,
